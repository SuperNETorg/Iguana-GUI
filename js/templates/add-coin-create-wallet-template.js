...
'<section class="form-container mdl add-coin-create-wallet-form unselectable hidden fade auth-main">' +
  ...
  '<div class="modal modal-add-coin-wallet-create-form" role="document">' +
      ...
      '<div class="modal-content">' +
        '<section class="create-account-form">' +
          ...
          '<div class="form-content modal-body">' +
            '<div class="login-add-coin-selection">' +
              '<div class="login-add-coin-selection-title cursor-pointer">' + helper.lang('LOGIN.SELECT_A_WALLET') + '</div>' +
            '</div>' +
        ...
        '<section class="verify-passphrase-form hidden">' +
          ...
          '<div class="form-content modal-body">' +
            ...
            '<button class="btn btn-block orange-gradient box-shadow-all text-shadow row btn-add-account-modal disabled">' + helper.lang('CREATE_ACCOUNT.ADD_ACCOUNT') + '</button>' +
          '</div>' +
        '</section>' +
