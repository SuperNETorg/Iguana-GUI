    ...
    '<div class="row centered">' +
      ...
      '<section class="form-container create-account-form">' +
        ...
        '<div class="form-content">' +
          ...
          '</div>' +
          '<div class="login-input-directions center offset-bottom-md unselectable passphrase-word-count">Write down this 24-word passphrase and keep it safe. You can\'t access or restore your account, if you lose it! <strong>Don\'t ever disclose your passphrase!</strong></div>' +
      ...
      '<section class="form-container verify-passphrase-form hidden">' +
        ...
        '</header>' +
        '<div class="form-content">' +
          '<div class="login-input-directions-error center offset-bottom-sm col-red hidden unselectable passphrase-word-count">Incorrect input. Passphrase must consist of 24 words. Try one more time.</div>' +
