    ...
    '<div class="row centered">' +
      '<section class="form-container login-form hidden">' +
        ...
        '<div class="form-content">' +
          ...
          '<div class="coind-iguana-notice center hidden"><strong>Is Iguana or *coind running?<br/>Make sure these <a href="https://github.com/SuperNETorg/Iguana-GUI/tree/0.1">requirements</a> are met.</strong></div>' +
